{:php-setup:}
$page_header = Globals::$site_name . " -Dump and Reload";
$page_title = Globals::$site_name . " - Dump and Reload Database";
$required_authority = 'X';
{:end-php-setup:}
{:style:}
#display-map-actions .display-target {display:none;}
#display-map-actions:hover ul {display:block;}

#create-map-form .display-target {display:none;}
#create-map-form:hover form {display:block;}
{:end-style:}

<?php
/*
#doc-start
h1.  ReloadDB.tpl - Admin Screen for dumping and rebuilding the database
...
*ReloadDB.tpl* manages archiving and unarchiving the database during
...
<p class="box ok">Return to <a class="underline" href="/AdminTools.tpl" title="Administration Tools">Admin Tools</a></p>
