...
------------------------------------
<h1>This is an included file</h1>
...
------------------------------------
<p class="error">Unable to Parse bad-file.tpl. Unable to resolve path to 'bad-file.tpl'</p>
------------------------------------
...
What is $foo?: <?php echo (isset($foo) ? $foo : '<?php echo ($foo = \'setting foo\'); ?>'); ?>
