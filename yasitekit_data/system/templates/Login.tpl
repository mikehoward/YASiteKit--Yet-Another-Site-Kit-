...
?>
{:php-setup:}
$page_header = Globals::$site_name . " - Login Please";
$page_title = "Login Form";
$form_action = "Login.tpl";
...
?>
  <div id="login-form">
    <div class="padded">
  <form action="Login.tpl" method="post" accept-charset="utf-8">
    <ul>
      <fieldset>
      <li>
...
function display_email_form($subject, $account_obj)
{
  ...
  echo $message_obj->form('Login.tpl');
...
switch (Globals::$rc->safe_post_submit) {
  ...
  case 'Submit':
    ...
    // echo $account_obj->dump('Login.tpl' . basename(__FILE__) . ':' . __LINE__);
